...
2. If the gun changes later on (which it most likely will), or you would like to exit the program, just type `ctrl + shift + p` on your computer and command prompt should pop up.
